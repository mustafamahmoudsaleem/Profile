...
<body>
    <div class="container">
            ...
            <div class="main-content">
                <div class="letter-section">
                    ...
                    <div class="video-preview" id="video-preview">
                        <img src="https://img.youtube.com/vi/stJeoh3ty1E/maxresdefault.jpg" alt="فيديو تعليمي لحرف الألف" id="video-thumbnail">
        ...
        <footer>
            <p>تم تطويره بواسطة المعلم مصطفى محمود</p>
        </footer>
    </div>
    ...
    <script>
        ...
        const arabicLetters = [
            ...
            { 
                ...
                thumbnail: 'https://img.youtube.com/vi/pJ8LlxHdyoI/maxresdefault.jpg',
                sound: 'م',
            ...
            { 
                ...
                thumbnail: 'https://img.youtube.com/vi/r8FDQNtpcTs/maxresdefault.jpg',
                sound: 'ه',
        ...
        function checkAnswer(selectedLetter, buttonElement) {
            ...
            if (selectedLetter === correctAnswer) {
                ...
                gameFeedbackElement.textContent = 'أحسنت! إجابة صحيحة 🎉';
